...
// FALLA TECNICA
	...
	Route::get('get_equipos_mantenimiento','EquipoController@get_equipos_mantenimiento');
	Route::get('formulario_mantenimiento/{id_equipo}','EquipoController@formulario_mantenimiento');
//ACTIVOS FIJOS
	...
	Route::post('save_falla_tecnica','EquipoController@save_falla_tecnica');
	Route::get('show_fallas/{id_equipo}','EquipoController@show_fallas');
	Route::get('register_reparacion/{id_equipo}','EquipoController@register_reparacion');
	Route::post('save_reparacion','EquipoController@save_reparacion');

	Route::get('get_tiempo_vida_equipos','EquipoController@get_tiempo_vida_equipos');
});
